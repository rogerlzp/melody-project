...
public class UserRealm extends AuthorizingRealm {
    ...
    @Reference(group = "sysUserService")
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        SysUser userDB = sysUserService.selectOne(new EntityWrapper<SysUser>().eq("uname", username));
        if (userDB == null) {
        ...
        Set<AuthVo> roles = sysRoleService.getRolesByUserId(userDB.getUid());
        Set<AuthVo> perms = sysPermService.getPermsByUserId(userDB.getUid());
