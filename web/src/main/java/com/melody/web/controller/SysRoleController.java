...
import com.melody.constant.PermType;
...
import com.melody.vo.UpdateRolePermVo;
...
public class SysRoleController {
    ...
    @Reference(group = "sysPermService")
    private SysPermService sysPermService;
    @Reference(group = "sysUserRoleService")
    private SysUserRoleService sysUserRoleService;
    @Reference(group = "sysRolePermService")
    ...
    public Json add(@RequestBody String body) {
        ...
        SysRole roleDB = sysRoleService.selectOne(new EntityWrapper<SysRole>().eq("rval", role.getRval()));
        if (roleDB != null) {
        ...
        boolean success = sysRoleService.insert(role);
    ...
    public Json delete(@RequestBody String body) {
        ...
        boolean success = sysRoleService.deleteById(rid);
        return Json.result(oper, success);
    }
    ...
    public Json query(@RequestBody String body) {
        ...
        Page<SysRole> page = sysRoleService.selectPage(new Page<>(current, size), queryParams);
    ...
    public Json updateRolePerm(@RequestBody UpdateRolePermVo vo) {
        ...
        boolean deleteRelationSucc = sysRolePermService.delete(deleteRelationParam);
        ...
        if (!pvals.isEmpty()) {
            ...
            boolean addSucc = sysRolePermService.insertBatch(list);
    ...
    public Json addPerm(@RequestBody String body) {
        ...
        boolean success = sysRolePermService.insert(new SysRolePerm(rid, pval, ptype));
        return Json.result(oper, success);
    }
    ...
    public Json deletePerm(@RequestBody String body) {
        ...
        Wrapper<SysRolePerm> deleteParam = new EntityWrapper<SysRolePerm>()
                ...
                .eq("perm_val", pval)
                .eq("perm_type", ptype);
        boolean success = sysRolePermService.delete(deleteParam);
    ...
    public Json findRolePerms(@PathVariable String rid) {
        ...
        List<SysPerm> perms = sysPermService.getPermsByRoleId(rid);
